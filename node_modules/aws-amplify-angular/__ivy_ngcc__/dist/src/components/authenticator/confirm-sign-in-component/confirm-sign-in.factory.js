...
function ConfirmSignInComponent_ng_template_1_Template(rf, ctx) { }
...
ConfirmSignInComponent.ɵfac = function ConfirmSignInComponent_Factory(t) { return new (t || ConfirmSignInComponent)(ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ComponentFactoryResolver)); };
ConfirmSignInComponent.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: ConfirmSignInComponent, selectors: [["amplify-auth-confirm-sign-in"]], viewQuery: function ConfirmSignInComponent_Query(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵviewQuery(DynamicComponentDirective, true);
    } if (rf & 2) {
        var _t;
        ɵngcc0.ɵɵqueryRefresh(_t = ɵngcc0.ɵɵloadQuery()) && (ctx.componentHost = _t.first);
    } }, inputs: { hide: "hide", framework: "framework", authState: "authState" }, decls: 2, vars: 0, consts: [["component-host", ""]], template: function ConfirmSignInComponent_Template(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵelementStart(0, "div");
        ɵngcc0.ɵɵtemplate(1, ConfirmSignInComponent_ng_template_1_Template, 0, 0, "ng-template", 0);
        ɵngcc0.ɵɵelementEnd();
    } }, directives: [ɵngcc1.DynamicComponentDirective], encapsulation: 2 });
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(ConfirmSignInComponent, [{
        type: Component,
        args: [{
                selector: 'amplify-auth-confirm-sign-in',
                template: "\n\t\t<div>\n\t\t\t<ng-template component-host></ng-template>\n\t\t</div>\n\t"
            }]
    }], function () { return [{ type: ɵngcc0.ComponentFactoryResolver }]; }, { hide: [{
            type: Input
        }], framework: [{
            type: Input
        }], authState: [{
